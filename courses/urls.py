...
urlpatterns = patterns('',
    url(r'^$',                  'courses.views.index', name='base_categorie'),
    url(r'^add/categorie/$',       'courses.views.add_categorie', name='add_categorie'),
    ...
    url(r'^show/(\d+)/$','courses.views.show_categorie', name='show_categorie'),
    url(r'^show/(\d+)/tut/$',   'courses.views.show_tut', name='show_tut'),
    url(r'^show/(\d+)/video/$', 'courses.views.show_video', name='show_video'),
    url(r'^publish/video/$', 'courses.views.publish_video', name='publish_video'),
    url(r'^tut/rate/(\d)/(\d)/$',   'courses.views.rate_tut', name='rate_tut'),
