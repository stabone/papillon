...
urlpatterns = patterns('',
    ...
    url(r'^form/$',        'users.views.user_form',    name='user_form'),
    url(r'^delete/$',      'users.views.user_delete',  name='user_delete'),
    url(r'^block/$',       'users.views.user_block',   name='user_block'),
    ...
    url(r'^create/author/$', 'users.views.create_author', name='create_author'),
)
