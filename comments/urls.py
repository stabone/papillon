...
urlpatterns = patterns('',
    ...
    url(r'^comment/article/$', 'comments.views.add_article_comment', name='article_comment'),
    url(r'^comment/article/delete/$', 'comments.views.delete_article_comment', name='delete_article_comm'),
)
