...
urlpatterns = patterns('',
    ...
    url(r'^*$', 'articles.views.list_review', name='review_base'),
    url(r'^add/*$', 'articles.views.add_review', name='review_add'),
    url(r'^edit/*$', 'articles.views.edit_review', name='review_edit'),
    url(r'^update/*$', 'articles.views.update_review', name='review_update'),
    url(r'^delete/*$', 'articles.views.delete_review', name='review_delete'),
)
